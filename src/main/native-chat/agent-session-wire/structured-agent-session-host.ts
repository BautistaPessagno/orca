...
import { structuredAgentSessionProviderSwitchDelegate } from './structured-agent-session-provider-switch'
...
export class StructuredAgentSessionHost {
  ...
  switchProvider = structuredAgentSessionProviderSwitchDelegate(() => this.attachContext())
