...
export function decideAgentLaunchMode(args: {
  ...
  // Structured orchestration workers exist only for Claude and Codex; ACP chats are user-launched.
  if (agent !== 'claude' && agent !== 'codex') {
    return downgraded(BLOCKER_REASON['agent-without-structured-session'], vocabulary)
  }
  return {
    mode: 'structured',
