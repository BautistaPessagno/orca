...
type NativeChatProviderSwitchProps = {
  onSwitchProvider?: NativeChatSwitchProvider
}

export type NativeChatBridgeViewProps = NativeChatProviderSwitchProps & {
  mode?: 'bridge'
...
export type NativeChatResolvedViewProps = NativeChatProviderSwitchProps & {
  paneKey: string
