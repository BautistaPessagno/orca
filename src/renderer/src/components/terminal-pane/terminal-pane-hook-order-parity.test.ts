...
// Then process-exit actions gained the in-place provider restart callback (212 hooks, 7 useMemo).
const PRE_REFACTOR_HOOK_ORDER_SHA256 =
  '8052553def54e7c180289475023466e6db4fa7ff9533b9aef67962850bab97b5'
